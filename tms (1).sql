...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 19, 2022 at 10:34 PM
...
INSERT INTO `review` (`fl`, `flg`, `id`) VALUES
('new.txt', '', 4);
...
INSERT INTO `review1` (`post`, `res`, `id`) VALUES
('This keyboard is very easy to type on, but the fingerprint reader is the best feature. It is very ac', '1', 1),
('It\'s thin and light. I can type pretty easily on it.', '1', 2),
('Good Keyboard and addition to the Surface Pro platform if you desire fingerprint scanner access. For', '1', 3);
...
INSERT INTO `review2` (`post`, `res`, `id`) VALUES
('bgfvcx', ' ', 1);
...
INSERT INTO `sens` (`a`, `id`, `b`, `c`, `d`) VALUES
('1', 4, '2', '3', '');
